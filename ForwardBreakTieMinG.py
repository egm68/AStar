...
def ComputePath(gridworld):
  ...
  while (s_goal.g_value > minInOpenListGMin().f_value):
        s_current = minInOpenListGMin()
...
def ForwardBreakTieMinG(gridworld, startRow, startCol, endRow, endCol, pdf):
    global S
    global s_start
    global s_goal
    global openList
...
pdf = matplotlib.backends.backend_pdf.PdfPages("ForwardBreakTieMinG_Paths.pdf")
...
pdf = ForwardBreakTieMinG(gridworld, startRow, startCol, endRow, endCol, pdf)
stop = timeit.default_timer()

print("Runtime of ForwardBreakTieMinG was " + str(stop - start))
